...
public class MenuController {
	 ...
	 * 	등 다양한 형식으로 표현될 수 있다.
	 * 	- 자원의 형식은 content-type, request-header에 의해 선택도니다.
	 * 	- REST방식을 사용하면 URI와 HTTP메서드만 확인시 어떤 기능을 하는지
	 * 	쉽게 알 수 있다.
	 * 	
	 * #2. Rest API
	...
	public ResponseEntity<Void> insertMenus(
		...
		int result = menuService.insertMenus(menu);
		if(result > 0) {
